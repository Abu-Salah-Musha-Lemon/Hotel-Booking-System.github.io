      ...
      <div class="row">
        ...
        <div class="card rounded shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="modal fade" id="edit_rooms" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" >
                <div class="modal-content ">
...
function edit_details(id){
  ...
  console.log(id);
  let editModal = new bootstrap.Modal(document.getElementById('edit_rooms'));
  //  editModal.show();
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-eA8VpXtH90dIkMrBq6hACeP6fzZbMxLlE1JBA9LbXakU31+6Z/hRTt8+pR6L4N2" crossorigin="anonymous"></script>
